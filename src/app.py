...
from tools.super_trend import SuperTrend
...
def trading():
    ...
    status: str = super_trend.get_status()
    logger.info(f'Статус супертренда: {status}')
