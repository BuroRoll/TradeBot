...
class SuperTrend:
    ...
    def calc_super_trend(self, df, period, multiplier, ohlc=['Open', 'High', 'Low', 'Close']):
        """
    ...
    def get_status(self):
        ...
        df_super_trend = self.calc_super_trend(df, 10, 3)
        self.status = df_super_trend['STX_10_3'].iloc[-1]
        return self.status
